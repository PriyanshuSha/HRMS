/* This is java program of HRMS (human resource management system) in which we perform operations like add employee , remove employee 
 * and Hike to the employee and here we deal with database also 
 * @author PRIYANSHU */
